...
CREATE TABLE IF NOT EXISTS  warehouse.bitcoin_prices (
...
CREATE TABLE IF NOT EXISTS  warehouse.crypto_statistics (
    symbol TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_crypto_statistics_symbol
ON warehouse.crypto_statistics(symbol);

-- Fast time-based analytics
CREATE INDEX IF NOT EXISTS idx_crypto_statistics_snapshot_time
ON warehouse.crypto_statistics(snapshot_time);

-- Fast lookup in raw table
CREATE INDEX IF NOT EXISTS idx_bitcoin_prices_symbol
ON warehouse.bitcoin_prices(symbol);

CREATE INDEX IF NOT EXISTS idx_bitcoin_prices_created_at
